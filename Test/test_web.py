...
class Test_web():
    ...
    def test_01(self):
        Web_WF.register("Yam", "Cohen", "yam", "123456")
        Web_WF.login("Yam", "123456")
        Web_WF.new_bank_account("Leumi", "123456789", "123123123")
        connected_user = Web_WF.current_connected_user()
        Web_WF.logout_user()
        Verifications.verify_equals(connected_user, "@yam")
    ...
    def test_04(self):
        Web_WF.register("Kuku", "Choen1", "kuku", "1234567")
        Web_WF.login("kuku", "1234567")
        Web_WF.fill_bank()
